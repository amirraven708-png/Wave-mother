...
void fuzzy_wave(const KP *kp, PSI *psi, Sol *s, Ellipse *mem) {
    // 1. start from best elite (or current solution)
...
int main() {
    ...
    FILE *log = fopen("psi_advanced_learning.csv", "w");
